...
console.log(process.env['SERVER_ENV'] === 'development');
axios.defaults.baseURL = (process.env['SERVER_ENV'] === 'development') ? 'http://192.168.1.192:8080' : 'http://35.176.223.209:8080';
